                                                        ...
                                                        <div class="card-body">
                                                                        ...
                                                                        <select class="form-control kt-selectpicker" name="durum">
                                                                            ...
                                                                            foreach ($status as $key => $val) {
                                                                                if($post['post_status'] == $val){
                                                                                    ...
                                                                                    echo '<option value="'.$val.'" '.$s.'>'.$key.'</option>';
                                                                                }
                                                                            }
                                                                            ?>
                                                                        </select>
                                                            ...
                                                            <div class="col-sm-12">
                                                                <div class="form-group float-right">
                                                                    <?php if($process == "edit"){?>
                                                                        <button type="button" class="btn btn-dark" data-id="<?php echo $editP['id'];?>" data-type="serviceEdit" name="set"><i class="fa fa-edit"></i> Düzenle</button>
                                                                    <?php }else{?>
                                                                        <button type="button" class="btn btn-success"  data-type="serviceAdd" name="set" ><i class="fa fa-plus"></i> Ekle</button>
                                                                    <?php }?>
                                                                </div>
                                                            </div>
                                                        </div>
