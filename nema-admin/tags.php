...
if($_SESSION['loggedin']==true){
    ...
    if($userKont['loginID'] == $_SESSION['loginid']){
        $pageTitle = "Etiket Yönetimi";
        $mpage = "content";
        $maltpage = "tags";
        $process = $_GET['process'];
        $processTitle = "Etiket Yönetimi";
        if($process == "edit"){
            $db->where ("id", $_GET["id"]);
            $editP = $db->getOne ("terms");
        }
?>
<!DOCTYPE html>
<html lang="tr">
                                        ...
                                        <div class="kt-portlet__head">
                                            <div class="kt-portlet__head-label">
                                                ...
                                                <h3 class="kt-portlet__head-title"> 
                                                    <?php if($process == "edit"){echo 'Etiket Düzenle';}else{echo 'Etiket Ekle';}?>
                                                </h3>
                                            </div>
                                            <div class="kt-portlet__head-toolbar">
                                                <div class="kt-portlet__head-wrapper">
    ...
    <script>
        ...
        function pagelist(){
            var table = $('#kt_table_1').DataTable({
                ajax: "../bwp-includes/ajax.php?i=tags&process=view",
                paging : true,
                responsive: true,
				displayLength: 100,
        ...
        function pageset(id,type){
            ...
            $.ajax({
                url: '../bwp-includes/ajax.php?i=tags&process=set',
                type: 'POST',
                data: data,
                success: function(e) {
                    if(type == "edit") {
